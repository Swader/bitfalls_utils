...
class Pagination
{
    ...
    /** @var string */
    protected $sSortLinkClass = 'header-link';
     ...
     * @return $this
     */
    public function setSortLinkClass($sClass)
    {
        $this->sSortLinkClass = $sClass;
        return $this;
    }
     ...
     * @return $this
     */
    public function appendSortLinkClass($sClass)
    {
        $this->sSortLinkClass .= ' ' . $sClass;
        return $this;
    }
     ...
     *
     * @param null $aCustomParams
     * @throws \InvalidArgumentException
     * @return string
     *
     */
    public function getUrlSuffix($aCustomParams = null)
    {

        $aSearchParams = ($aCustomParams) ? $aCustomParams : $this->oInjectedResult->getSearchParams();

        if ($this->sUrlSuffix === null || $aCustomParams) {
            if ($this->getUrlMode() == self::URL_MODE_QUERY) {
                $sUrlParamString = '?';
                foreach ($aSearchParams as $k => $v) {
